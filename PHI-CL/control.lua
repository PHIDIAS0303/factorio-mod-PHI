...
local function gui_create(player)
    ...
    do
        ...
        local read_type_table = frame.add({type = 'table', name = 'read_type_table', column_count = 2, style = 'table'})
        ...
        local set_type_table = frame.add({type = 'table', name = 'set_type_table', column_count = 2, style = 'table'})
