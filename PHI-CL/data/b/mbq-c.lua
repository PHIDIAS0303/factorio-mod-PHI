return {
    ...
    ['battery-equipment'] = {
        ...
        max = settings.startup['PHI-MB-EQUIPMENT'].value + ((mods['space-age'] and 2) or 1)
    },
    -- MBQ A 2 BASE ARMOR_EQUIPMENT,RECIPE,RESEARCH_EFFECT
    ...
    ['energy-shield-equipment'] = {
        ...
        min = 3,
        max = settings.startup['PHI-MB-EQUIPMENT'].value + 1
    },
    -- MBQ A 2 BASE ARMOR_EQUIPMENT,RECIPE,RESEARCH_EFFECT
    ['exoskeleton-equipment'] = {
        ...
        max = settings.startup['PHI-MB-EQUIPMENT'].value or 1
    },
    -- MBQ A 2 BASE ARMOR_EQUIPMENT,RECIPE,RESEARCH_EFFECT
    ...
    ['night-vision-equipment'] = {
        ...
        max = math.min(settings.startup['PHI-MB-EQUIPMENT'].value, 2)
    },
    -- MBQ A 2 BASE ARMOR_EQUIPMENT,RECIPE,RESEARCH_EFFECT
